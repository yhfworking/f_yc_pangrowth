...
class SearchNovelDelegate extends SearchDelegate<String> {
  ...
  Widget buildResults(BuildContext context) {
    return FutureBuilder<NovelEntity>(
      future: YcPangrowth.pangrowthNovel
          .searchNovelResults(queryContent: query, offset: 1, limit: 20),
              ...
              if (snapshot.data!.data != null) {
                return ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return InkWell(
                        onTap: () async {
                          YcPangrowth.pangrowthNovel
                              .openNovelPageWithUrl(url: result.readUrl);
                        },
                        child: Container(
  ...
  Widget buildSuggestions(BuildContext context) {
    return FutureBuilder<NovelEntity>(
      future: YcPangrowth.pangrowthNovel
          .searchNovelSuggestions(queryContent: query),
      builder: (context, snapshot) {
        switch (snapshot.connectionState) {
          case ConnectionState.none:
          case ConnectionState.waiting:
