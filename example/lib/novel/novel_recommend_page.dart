import 'package:f_yc_pangrowth/entity/novel_entity.dart';
...
class _NovelRecommendV1State extends State<NovelRecommendPage> {
  Future<NovelEntity> getNovel() async {
    switch (widget.type) {
      case "history":
        return YcPangrowth.pangrowthNovel.getNovelHistory();
      case "feedV1":
        return YcPangrowth.pangrowthNovel.getNovelRecommendV1(size: 10);
    }
    return YcPangrowth.pangrowthNovel.getNovelRecommendFeed(size: 10);
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: FutureBuilder<NovelEntity>(
        future: YcPangrowth.pangrowthNovel.getNovelRecommendV1(
          size: 10,
        ),
                  ...
                  return ListView.builder(
                    ...
                    itemBuilder: (BuildContext context, int index) {
                      ...
                      return InkWell(
                        onTap: () async {
                          //书籍曝光
                          await YcPangrowth.pangrowthNovel
                              .reportRecentNovelShow(
                                  type: result.type, book: result.novelDetail);
                          //书籍跳转
                          await YcPangrowth.pangrowthNovel
                              .openNovelPageWithConfig(
                                  type: result.type, book: result.novelDetail);
                        },
                        child: Container(
